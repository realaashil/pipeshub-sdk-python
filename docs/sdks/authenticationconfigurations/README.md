...
* [get_azure_ad](#get_azure_ad) - Get Azure AD configuration
...
with Pipeshub(
    ...
    res = p_client.authentication_configurations.get_azure_ad()
...
with Pipeshub(
    ...
    res = p_client.authentication_configurations.get_generic_o_auth_config()
