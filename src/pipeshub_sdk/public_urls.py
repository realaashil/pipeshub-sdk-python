...
class PublicURLs(BaseSDK):
    ...
    def set_frontend_public_url(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/configurationManager/frontendPublicUrl",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="setFrontendPublicUrl",
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="getFrontendPublicUrl",
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.URLConfig, http_res)
    ...
    async def get_frontend_public_url_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def set_connector_public_url(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/configurationManager/connectorPublicUrl",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="setConnectorPublicUrl",
                oauth2_scopes=["config:write"],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="getConnectorPublicUrl",
                oauth2_scopes=["config:read"],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def get_connector_public_url_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
