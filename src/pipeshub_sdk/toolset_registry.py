...
class ToolsetRegistry(BaseSDK):
    ...
    def list_toolset_registry(
        ...
        *,
    ...
    ) -> models.ListToolsetRegistryResponse:
        r"""List available toolsets
        ...
        request = models.ListToolsetRegistryRequest(
            page=page,
            limit=limit,
            search=search,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="listToolsetRegistry",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ListToolsetRegistryResponse, http_res)
    ...
    async def list_toolset_registry_async(
        self,
        *,
        page: Optional[int] = 1,
        limit: Optional[int] = 50,
    ...
    def get_toolset_schema(
        ...
        *,
        ...
        request = models.GetToolsetSchemaRequest(
    ...
    async def get_toolset_schema_async(
        self,
        *,
        toolset_type: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
