...
class RemoveUserFromTeamRequestTypedDict(TypedDict):
    team_id: str
    body: RemoveUserFromTeamRequestBodyTypedDict
    r"""Request payload"""
...
class RemoveUserFromTeamResponseTypedDict(TypedDict):
    r"""User removed from team successfully"""
...
try:
    RemoveUserFromTeamRequestBody.model_rebuild()
except NameError:
    pass
