...
class PlatformSettingsSDK(BaseSDK):
    ...
    def set_platform_settings(
        ...
        **Available Feature Flags:**
        ...
        request = models.SetPlatformSettingsRequest(
            file_upload_max_size_bytes=file_upload_max_size_bytes,
            feature_flags=feature_flags,
        )

        req = self._build_request(
            method="POST",
            path="/configurationManager/platform/settings",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="setPlatformSettings",
    ...
    async def set_platform_settings_async(
        self,
        *,
        file_upload_max_size_bytes: int,
        feature_flags: Dict[str, bool],
    ...
    def get_platform_settings(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.PlatformSettings, http_res)
    ...
    async def get_platform_settings_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def get_available_feature_flags(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetAvailableFeatureFlagsResponse:
        r"""Get available feature flags
        ...
        req = self._build_request(
            method="GET",
            path="/configurationManager/platform/feature-flags/available",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="getAvailableFeatureFlags",
                oauth2_scopes=["config:read"],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.GetAvailableFeatureFlagsResponse, http_res
            )
        if utils.match_response(http_res, ["401", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.PipeshubDefaultError(
    ...
    async def get_available_feature_flags_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def set_custom_system_prompt(
        ...
        *,
        ...
        req = self._build_request(
            method="PUT",
            path="/configurationManager/prompts/system",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="setCustomSystemPrompt",
                oauth2_scopes=["config:write"],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def set_custom_system_prompt_async(
        self,
        *,
        custom_system_prompt: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="getCustomSystemPrompt",
                oauth2_scopes=["config:read"],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.CustomSystemPrompt, http_res)
        if utils.match_response(http_res, ["401", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.PipeshubDefaultError(
                "API error occurred", http_res, http_res_text
    ...
    async def get_custom_system_prompt_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
