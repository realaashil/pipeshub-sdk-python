...
class AgentConversations(BaseSDK):
    ...
    ) -> models.ListAgentConversationsResponse:
    ...
    async def get_agent_conversation_async(
        self,
        *,
        agent_key: str,
        conversation_id: str,
    ...
    async def stream_agent_message_async(
        self,
        *,
        agent_key: str,
        conversation_id: str,
    ...
    async def regenerate_agent_answer_async(
        self,
        *,
        agent_key: str,
        conversation_id: str,
