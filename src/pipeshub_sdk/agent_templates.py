...
class AgentTemplates(BaseSDK):
    ...
    async def list_agent_templates_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def create_agent_template_async(
        self,
        *,
        name: str,
        description: Optional[str] = None,
    ...
    async def get_agent_template_async(
        self,
        *,
        template_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def update_agent_template_async(
        self,
        *,
        template_id: str,
        name: Optional[str] = None,
    ...
    async def delete_agent_template_async(
        self,
        *,
        template_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
