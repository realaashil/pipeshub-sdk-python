...
class ConnectorInstances(BaseSDK):
    ...
    async def list_connector_instances_async(
        self,
        *,
        scope: Optional[models.ConnectorScope] = None,
        page: Optional[int] = 1,
    ...
    async def create_connector_instance_async(
        self,
        *,
        connector_type: str,
        instance_name: str,
    ...
    async def list_active_connectors_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    async def list_inactive_connectors_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def list_configured_connectors(
        self,
        *,
        scope: Optional[models.ConnectorScope] = None,
        page: Optional[int] = 1,
    ...
    async def list_configured_connectors_async(
        self,
        *,
        scope: Optional[models.ConnectorScope] = None,
        page: Optional[int] = 1,
    ...
    def list_active_agent_connectors(
        self,
        *,
        scope: Optional[models.ConnectorScope] = None,
        page: Optional[int] = 1,
    ...
    async def list_active_agent_connectors_async(
        self,
        *,
        scope: Optional[models.ConnectorScope] = None,
        page: Optional[int] = 1,
    ...
    async def get_connector_instance_async(
        self,
        *,
        connector_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                oauth2_scopes=["connector:delete"],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
            ),
    ...
    async def delete_connector_instance_async(
        self,
        *,
        connector_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def update_connector_name_async(
        self,
        *,
        connector_id: str,
        instance_name: str,
