...
class ConnectorFilters(BaseSDK):
    ...
    async def get_connector_filters_async(
        self,
        *,
        connector_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def save_connector_filters_async(
        self,
        *,
        connector_id: str,
        filters: Dict[str, Any],
    ...
    async def get_filter_field_options_async(
        self,
        *,
        connector_id: str,
        filter_key: str,
