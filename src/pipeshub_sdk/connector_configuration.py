...
class ConnectorConfiguration(BaseSDK):
    ...
    def get_connector_config(
        ...
        *,
    ...
    ) -> models.GetConnectorConfigResponse:
        r"""Get connector configuration
        ...
        request = models.GetConnectorConfigRequest(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GetConnectorConfigResponse, http_res)
    ...
    async def update_connector_config_async(
        self,
        *,
        connector_id: str,
        auth: Optional[
    ...
    def update_connector_auth_config(
        self,
        *,
        connector_id: str,
    ...
    async def update_connector_auth_config_async(
        self,
        *,
        connector_id: str,
        auth: Union[models.ConnectorAuthConfig, models.ConnectorAuthConfigTypedDict],
    ...
    def update_connector_filters_sync_config(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.UpdateConnectorFiltersSyncConfigResponse:
        r"""Update filters and sync configuration
        ...
        request = models.UpdateConnectorFiltersSyncConfigRequest(
            connector_id=connector_id,
        ...
        req = self._build_request(
            method="PUT",
            path="/connectors/{connectorId}/config/filters-sync",
            base_url=base_url_,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url_ or "",
                operation_id="updateConnectorFiltersSyncConfig",
                oauth2_scopes=["connector:write"],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.UpdateConnectorFiltersSyncConfigResponse, http_res
            )
    ...
    async def update_connector_filters_sync_config_async(
        self,
        *,
        connector_id: str,
        sync: Optional[
