...
class CrawlingJobs(BaseSDK):
    ...
    **Schedule Types:**
    ...
    async def schedule_crawling_job_async(
        self,
        *,
        connector: str,
        connector_id: str,
    ...
    async def get_crawling_job_status_async(
        self,
        *,
        connector: str,
        connector_id: str,
    ...
    async def remove_crawling_job_async(
        self,
        *,
        connector: str,
        connector_id: str,
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="removeAllCrawlingJob",
                oauth2_scopes=["crawl:delete"],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.RemoveAllCrawlingJobResponse, http_res
            )
        if utils.match_response(http_res, ["401", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.PipeshubDefaultError(
    ...
    def get_queue_stats(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GetQueueStatsResponse, http_res)
        if utils.match_response(http_res, ["401", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.PipeshubDefaultError(
                "API error occurred", http_res, http_res_text
