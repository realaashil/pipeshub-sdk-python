...
class ListActiveAgentConnectorsRequestTypedDict(TypedDict):
...
class ListActiveAgentConnectorsRequest(BaseModel):
    scope: Annotated[
...
class ListActiveAgentConnectorsResponseTypedDict(TypedDict):
    r"""Active agent connectors retrieved"""
...
class ListActiveAgentConnectorsResponse(BaseModel):
    r"""Active agent connectors retrieved"""
